...
@section('titulo_pagina', 'Aquisição de Materiais por Comarca/Tribunal')
    ...
    <div class="container">
        ...
        <div class="form-top naoimprimir">
            <form method="GET" action="{{ route('relatorios.gerais.imprimir') }}" class="form-inline" id="formPesquisa">
                <input type="hidden" name="relatorio" value="{{ $filtros['relatorio'] ?? 'aquisicao_materiais_comarca' }}">
        ...
        @if($mostrarDados)
            <table cellspacing="0" cellpadding="2" width="100%" border="0" style="margin-bottom: 20px;">
                ...
                <tr>
                    <td valign="bottom" style="border-bottom: 1px solid #000; font-size: 12px; font-weight: bold;">Relatório de Aquisição de Materiais por Comarca/Tribunal</td>
                ...
                <tr>
                    <td colspan="4" align="center" style="border: 1px solid #000; font-size: 18px; font-weight: bold; padding: 5px;">
                        Aquisição de Materiais por Comarca/Tribunal
                    </td>
                </tr>
                <tr><td colspan="4" style="height: 10px;"></td></tr>
                <tr>
            ...
            <form method="GET" action="{{ route('relatorios.gerais.imprimir') }}">
                <input type="hidden" name="relatorio" value="aquisicao_materiais_comarca">
