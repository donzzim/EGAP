...
@section('tabela')
    <table>
        <tr>
            <th colspan="3" class="no-border-bottom">TABELA 17</th>
            <th colspan="9" class="text-center">DEMONSTRATIVO ANALÍTICO DAS ENTRADAS E SAÍDAS DO ALMOXARIFADO DE MATERIAL PERMANENTES</th>
        </tr>
        <tr>
        ...
        @forelse ($dados as $linha)
            ...
            @php
                ...
                $t['eo'] += $linha->ent_outras;  $t['et'] += $linha->total_entradas;
